...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
    React is a JS library that is used to create user interfaces. 

1. Describe component state.
    State is the container that triggers when a user interfaces with the web site. 

1. Describe props.
    Props is a React Keyword and is used to pass data from one componenet to another.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
    Not 100% sure but I know it affects something outside the scope of the current fucntion that's being executed. 
